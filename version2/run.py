...
commands={'science':'experiments.science','reproduce':'experiments.reproduce_version1',
          ...
          'fetcheye':'experiments.fetch_eye_color_data','package':'experiments.package_release'}
if len(sys.argv)<2 or sys.argv[1] not in {*commands,'test'}:
    raise SystemExit('Usage: python run.py {test|reproduce|science|benchmark|eyecolor|complexity|manuscript|unified|package|fetch|fetcheye} [arguments]')
