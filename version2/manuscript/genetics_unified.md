...
An exponentially branching process collapses into a matrix power, and everything linear algebra knows about such operators becomes available. [1]
...
The heterozygote advantage in malarial regions is the standard explanation for the allele's persistence, and it is the assumption that would have to be dropped to model those regions correctly. [3]
...
The ABO locus carries three alleles: I^A, I^B and i. A and B are codominant, and both are dominant to O. [3] Version I introduced a weighting scheme to score genotypes, assigning full expressive weight to the antigen-producing alleles and none to the recessive one:
...
Version I takes worldwide phenotype shares of approximately O 44%, A 42%, B 10%, AB 4%, and applies the Hardy-Weinberg relations to recover allele frequencies p_A = 0.26, p_B = 0.077, p_O = 0.663, which sum to one. [4] Genotype probabilities follow as
...
The RHD gene encodes the D antigen. In the simplified model used here, D is dominant and d recessive, giving genotypes DD, Dd and dd and phenotypes positive, positive and negative. Two Rh-positive parents who are both Dd have a one-quarter chance of a dd child. [5]
...
- **CSR** stores only positive transmissions with child-row indices and row pointers, built through compressed columns and converted for repeated updates. [4]
...
For fully specified parents and a fully specified child, the log probability is the sum of per-locus log probabilities: O(n) arithmetic and O(n) local storage, with no enumeration. This is probability factorisation, not a general pedigree solver; tree-structured factor graphs admit exact messages while arbitrary loops do not, and general variable elimination can require factors exponential in induced width. [7] [8]
...
A trie can share prefixes and answer partial-genotype queries, but a complete n-locus ternary trie still has (3^(n+1) - 1)/2 nodes; dynamic allocation reduces unused pointers without reducing catalog size. [9] [10] A hash map gives expected constant probes for fixed-size keys while hashing a long multilocus key still costs length-dependent work. [11] Reduced decision graphs merge equal suffix computations, but their size depends on the function and the variable order. [12] A priority queue can visit likely outcomes first, but ordering an incomplete output does not make it a distribution. [13]
...
At one locus with allele probabilities p and q = 1 - p, independent gametes give genotype probabilities p^2, 2pq, q^2, and under the idealised large-population neutral random-mating model these persist across generations. [4] Selection, migration, non-random mating, drift, sampling and genotyping behaviour can all make an observed sample differ. The algebra alone does not license reading a pooled global phenotype percentage as a universal genotype distribution, which is exactly what Part II's ABO inputs did.
...
**Simplified M/N.** A two-allele codominant abstraction; MN x MN gives MM 1/4, MN 1/2, NN 1/4. The transmission engine needs no change, which is the point: dominance belongs to the genotype-phenotype map, not to the inheritance probabilities. [19]
...
**Linkage and phase.** Two individuals both described as Aa/Bb may carry haplotypes AB/ab or Ab/aB. With recombination fraction r the first transmits AB and ab at (1-r)/2 each and recombinants at r/2; the second reverses this. At r = 0 the gamete supports are disjoint; at r = 1/2 they coincide. [6]
...
A Wilson 95% interval for the simulated coverage is [89.427%, 90.602%]. [21] Independent simulation used binomial sampling plus Gaussian draws rather than resampling the computed array, and no seed was searched for a passing result. [22]
...
The score is not measured in centimetres, has no fitted human effect sizes, and contains no environmental covariates; its residual distribution is known because it was stipulated. Large-scale height research illustrates the gap: a saturated map of common height-associated variants analysed approximately 5.4 million people and reported 12,111 associated independent SNPs, with materially different out-of-sample variance explained across ancestry groups. [23] That result motivates linkage-aware models, independent validation and population-specific calibration. It is not a performance claim about this work.
...
Version I identified this gap explicitly, noting that random mutation can occur in an individual before they reproduce and that the model cannot represent it. [1] The gap survived into the complete kernel unchanged: better representation did nothing about it.
...
Sequencing 78 Icelandic parent-offspring trios gave an average de novo mutation rate of 1.20e-8 per nucleotide per generation at mean paternal age 29.7, with the count rising by roughly two mutations per year of paternal age. [24] The larger follow-up, 1,548 trios and 108,778 high-quality de novo mutations, averaged 70.3 per trio and separated the parental contributions: 1.51 additional mutations per year of paternal age against 0.37 per year of maternal age. [25]
...
Somatic mutation does not change what an individual transmits; it changes the individual. Adult stem cells of liver, colon and small intestine accumulate roughly 40 novel mutations per year, at broadly similar rates across those tissues despite very different cancer incidence. [26]
...
Averaging across a locus's sites gives the observable m_l(t). That methylation carries reproducible age information is established: a multi-tissue age predictor was built from approximately 8,000 samples across 51 healthy tissues and cell types [31], and a quantitative ageing model over more than 450,000 CpG markers in whole blood from 656 individuals aged 19 to 101 measured individual differences in methylome ageing rate [32]. Neither licenses the claim that methylation *causes* ageing.
...
This is a generalised linear model with a binomial response and a logit link. [33] The score is nonlinear in age, through m_l(t) and h_l(t) which are themselves nonlinear by Result 19.1, but it is **linear in the parameters**, and that single property determines everything in Section 21.
...
|---|---|---|---|
| w_met | negative | Promoter-island methylation associated with repression [29] | The model is wrong, the sites are gene-body not promoter, or the annotation is misassigned |
| w_ac | positive | Activating acetylation marks open chromatin [30] | The same three candidates, in the same order |
...
Squared error is not used: under a binary response it is non-convex after composition with the logistic link, and cross-entropy is the log-likelihood of the assumed response distribution. [33]
...
|---|---|---|
| Germline de novo count rises linearly with paternal age at roughly 1.5 per year | Section 16.1 [25] | A trio cohort with a materially different or nonlinear slope |
...
| w_met is negative at promoter islands | Section 20 [29] | A fitted positive coefficient on correctly annotated promoter sites |
...
| Age-of-onset hazard has log-log slope k-1 | Result 18.2 [27] | An incidence curve inconsistent with any integer k |
...
The original 54-page study and its DOCX source are retained unedited alongside this work. Its SHA-256 digest before the extension was EE3CB04CE28D4734669D5822FDDBDF03C176FD5C2F5FF3760CB82A4BD1145ECD. [1]
...
[2] National Center for Biotechnology Information. NM_000518.5(HBB):c.20A>T (p.Glu7Val), ClinVar VCV000015333.7. [https://www.ncbi.nlm.nih.gov/clinvar/variation/VCV000015333.7/](https://www.ncbi.nlm.nih.gov/clinvar/variation/VCV000015333.7/) Accessed 2026-09-05.

[3] M. A. Bender, Katie Carlberg. Sickle Cell Disease. 2025. [https://www.ncbi.nlm.nih.gov/books/NBK1377/](https://www.ncbi.nlm.nih.gov/books/NBK1377/) Accessed 2026-09-05.

[4] G. H. Hardy. Mendelian Proportions in a Mixed Population. 1908. DOI: 10.1126/science.28.706.49. [https://pubmed.ncbi.nlm.nih.gov/17779291/](https://pubmed.ncbi.nlm.nih.gov/17779291/) Accessed 2026-09-05.
...
[6] T. A. Brown. Mapping Genomes. 2002. [https://www.ncbi.nlm.nih.gov/books/NBK21116/](https://www.ncbi.nlm.nih.gov/books/NBK21116/) Accessed 2026-09-05.

[7] Frank R. Kschischang, Brendan J. Frey, Hans-Andrea Loeliger. Factor Graphs and the Sum-Product Algorithm. 2001. IEEE Transactions on Information Theory 47(2):498-519. DOI: 10.1109/18.910572. [https://haloeliger.github.io/papers/2001FG.pdf](https://haloeliger.github.io/papers/2001FG.pdf) Accessed 2026-09-05.

[8] Rina Dechter. Bucket elimination: A unifying framework for reasoning. 1999. Artificial Intelligence 113(1-2):41-85. DOI: 10.1016/S0004-3702(99)00059-4. [https://www.sciencedirect.com/science/article/pii/S0004370299000594](https://www.sciencedirect.com/science/article/pii/S0004370299000594) Accessed 2026-09-05.

[9] Robert Sedgewick, Kevin Wayne. Algorithms, 4th edition: 5.2 Tries. [https://algs4.cs.princeton.edu/52trie/](https://algs4.cs.princeton.edu/52trie/) Accessed 2026-09-05.

[10] Roberto Grossi, Giuseppe Ottaviano. Fast Compressed Tries through Path Decompositions. 2011. [https://arxiv.org/abs/1111.5220](https://arxiv.org/abs/1111.5220) Accessed 2026-09-05.

[11] Robert Sedgewick, Kevin Wayne. Algorithms, 4th edition: 3.4 Hash Tables. [https://algs4.cs.princeton.edu/34hash/](https://algs4.cs.princeton.edu/34hash/) Accessed 2026-09-05.

[12] Randal E. Bryant. Graph-Based Algorithms for Boolean Function Manipulation. 1986. IEEE Transactions on Computers C-35(8):677-691. DOI: 10.1109/TC.1986.1676819. [https://www.cs.cmu.edu/~bryant/pubdir/ieeetc86.pdf](https://www.cs.cmu.edu/~bryant/pubdir/ieeetc86.pdf) Accessed 2026-09-05.

[13] Python Software Foundation. heapq: Heap queue algorithm. [https://docs.python.org/3/library/heapq.html](https://docs.python.org/3/library/heapq.html) Accessed 2026-09-05.

[14] Ensembl, The 1000 Genomes Project Consortium. rs334 population genotype and allele counts, 1000GENOMES:phase_3 subset. [https://rest.ensembl.org/variation/human/rs334?population_genotypes=1;pops=1;content-type=application/json](https://rest.ensembl.org/variation/human/rs334?population_genotypes=1;pops=1;content-type=application/json) Accessed 2026-09-05.

[15] The 1000 Genomes Project Consortium. A global reference for human genetic variation. 2015. DOI: 10.1038/nature15393. [https://www.nature.com/articles/nature15393](https://www.nature.com/articles/nature15393) Accessed 2026-09-05.

[16] International Genome Sample Resource. IGSR Disclaimer. [https://www.internationalgenome.org/IGSR_disclaimer/](https://www.internationalgenome.org/IGSR_disclaimer/) Accessed 2026-09-05.

[17] Janis E. Wigginton, David J. Cutler, Goncalo R. Abecasis. A Note on Exact Tests of Hardy-Weinberg Equilibrium. 2005. DOI: 10.1086/429864. [https://pmc.ncbi.nlm.nih.gov/articles/PMC1199378/](https://pmc.ncbi.nlm.nih.gov/articles/PMC1199378/) Accessed 2026-09-05.

[18] Sture Holm. A Simple Sequentially Rejective Multiple Test Procedure. 1979. Scandinavian Journal of Statistics 6(2):65-70. [https://www.jstor.org/stable/4615733](https://www.jstor.org/stable/4615733) Accessed 2026-09-05.

[19] Laura Dean. The MNS blood group. 2005. [https://www.ncbi.nlm.nih.gov/books/NBK2274/](https://www.ncbi.nlm.nih.gov/books/NBK2274/) Accessed 2026-09-05.

[20] Laura Dean. The Hh blood group. 2005. [https://www.ncbi.nlm.nih.gov/books/NBK2268/](https://www.ncbi.nlm.nih.gov/books/NBK2268/) Accessed 2026-09-05.

[21] NIST/SEMATECH. e-Handbook of Statistical Methods: 7.2.4.1 Confidence intervals. [https://itl.nist.gov/div898/handbook/prc/section2/prc241.htm](https://itl.nist.gov/div898/handbook/prc/section2/prc241.htm) Accessed 2026-09-05.

[22] SciPy developers. scipy.stats.kstest. [https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats